...
const AboutBook: React.FC = () => (
    <section className="max-w-3xl mx-auto py-16 px-4">
        <h2 className="text-3xl font-bold mb-6 text-center">Introduction: Why This Playbook Exists</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
            <strong>This is that map.</strong> It’s not glossy. It’s not cute. It won’t win you likes. But it might help you find traction, clarity, and the courage to keep moving.
        </p>
